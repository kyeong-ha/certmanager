...
class User(models.Model):
    ...
    education_sessions = models.ManyToManyField(EducationCenterSession, related_name='users', blank=True) # 교육원명+기수
    ...
    def latest_education_session(self):
        return self.education_sessions.order_by('-updated_at', '-created_at').first()
